...
#pragma mark - Actions
- (void)btnImageRightClicked:(UIButton *)btn
{
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (!cell) {
        ...
        UIButton *btnTest = [[UIButton alloc]initWithFrame:CGRectMake(CGRectGetWidth(cell.contentView.bounds)-130, 7, 120, CGRectGetHeight(cell.contentView.bounds)-14)];
    ...
    if (indexPath.row < self.arrayItems.count) {
        UIButton *btnTest = (UIButton *)[cell.contentView viewWithTag:100];
